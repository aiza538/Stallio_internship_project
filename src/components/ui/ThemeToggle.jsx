...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      {isDark ? (
        <Sun className="h-4 w-4 transition-transform duration-500 ease-snappy group-hover:rotate-90" strokeWidth={2} />
      ) : (
        <Moon className="h-4 w-4 transition-transform duration-500 ease-snappy group-hover:-rotate-12" strokeWidth={2} />
      )}
    </button>
  );
}