        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-purple-200 via-purple-100 to-indigo-100 dark:from-indigo-700 dark:via-purple-800 dark:to-violet-900 p-10 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="mt-12 text-5xl font-bold text-purple-900 dark:text-white leading-tight">
              Your store, <br />
              <span className="text-indigo-700 dark:text-indigo-300">one link away.</span>
            </h1>
            <p className="mt-4 text-lg text-indigo-700 dark:text-indigo-300">Manage your catalog, orders, and customers from a single beautiful dashboard.</p>
          </div>
        ...
        <div className="w-full md:w-1/2 bg-white/90 dark:bg-[#18132a]/90 backdrop-blur-lg p-6 sm:p-10 flex flex-col justify-center">
          ...
          <div className="md:hidden mb-6 text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              {/* leading-none ensures no extra height, mt-0 avoids jump */}
            ...
            <span className="inline-flex items-center gap-2 rounded-full bg-indigo-100 dark:bg-indigo-900/40 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-indigo-700 dark:text-indigo-300">
              <Sparkles className="h-3.5 w-3.5" /> Seller Login
            </span>
            <h2 className="mt-3 text-3xl font-bold text-slate-900 dark:text-white">Welcome <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-violet-600 bg-clip-text text-transparent dark:from-indigo-300 dark:via-purple-300 dark:to-violet-300">back</span></h2>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Sign in to your Stallio dashboard</p>
          </div>
          ...
          <div className="hidden md:block">
            ...
            <h2 className="font-display text-3xl font-bold text-slate-900 dark:text-white">Welcome <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-violet-600 bg-clip-text text-transparent dark:from-indigo-300 dark:via-purple-300 dark:to-violet-300">back</span></h2>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Sign in to your Stallio dashboard</p>
          </div>
          ...
          <form className="mt-6 md:mt-8 space-y-6" onSubmit={handleSubmit} noValidate>
            <div className="space-y-5">
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Password <span className="text-red-500">*</span></label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" onClick={handleForgotPassword} className="text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors duration-300">Forgot password?</Link>
              </div>
            </div>
            ...
            <div className="text-center text-sm">
              ...
              <Link to="/signup" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors duration-300">Sign up free</Link>
            </div>
          </form>
        </div>
      </div>
