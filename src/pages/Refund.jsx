  ...
  const sections = [
    {
      ...
      title: t('refund.section1.title'),
      content: t('refund.section1.content'),
      note: t('refund.section1.note'),
      type: 'text'
    },
    {
      id: 2,
      ...
      title: t('refund.section2.title'),
      content: t('refund.section2.content'),
      type: 'text'
    },
    {
      id: 3,
      ...
      title: t('refund.section3.title'),
      content: t('refund.section3.content'),
      type: 'text'
    },
    {
      id: 4,
      ...
      title: t('refund.section4.title'),
      content: t('refund.section4.content'),
      type: 'text'
    },
    {
      id: 5,
      ...
      title: t('refund.section5.title'),
      content: t('refund.section5.content'),
      type: 'text'
    },
    {
      id: 6,
      ...
      title: t('refund.section6.title'),
      content: t('refund.section6.content'),
      note: t('refund.section6.note'),
      type: 'text'
    }
  ];
    ...
    <div className="min-h-screen py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-50/60 via-purple-50/40 to-white/80 dark:from-indigo-950/40 dark:via-purple-950/30 dark:to-slate-900/80">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          {/* ✅ Dynamic Heading - "Refund" black + "Policy" purple for EN, ES, AR */}
