      ...
      <div className="mx-auto max-w-5xl relative z-10">
        ...
        <div className="relative overflow-hidden rounded-2xl p-5 sm:p-6 shadow-lg shadow-purple-500/5 transition-all duration-300 hover:shadow-xl">
          ...
          <div className="relative z-10">
            <h2 className="text-lg font-semibold text-purple-900 dark:text-white mb-1">
            ...
            {resendStatus === 'success' && (
              <div className="mt-3 flex items-center gap-2 rounded-lg bg-green-100 dark:bg-green-900/30 p-2.5 text-sm text-green-700 dark:text-green-300">
            ...
            {resendStatus === 'error' && (
              <div className="mt-3 flex items-center gap-2 rounded-lg bg-red-100 dark:bg-red-900/30 p-2.5 text-sm text-red-700 dark:text-red-400">
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-300/70 dark:border-white bg-white/70 dark:bg-white px-6 py-2.5 text-sm font-medium text-slate-700 dark:text-purple-700 hover:bg-purple-50 dark:hover:bg-purple-50 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed backdrop-blur-sm"
              >
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-300/70 dark:border-white bg-white/70 dark:bg-white px-6 py-2.5 text-sm font-medium text-purple-600 dark:text-purple-700 hover:bg-purple-50 dark:hover:bg-purple-50 transition-all duration-300"
              >
                {t("verifyActions.contactSupport")} <ArrowRight className="h-4 w-4" />
              </Link>
            </div>

            <div className="mt-4 pt-4 border-t border-purple-200/50 dark:border-white/10">
              <p className="text-xs text-indigo-700 dark:text-indigo-100">
