    ...
    <section ref={ref} className={`relative overflow-hidden bg-white px-4 py-16 sm:px-6 lg:px-8 lg:py-24 dark:bg-[#0d071a] scroll-reveal ${isVisible ? 'visible' : ''}`}>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 lg:grid-cols-3 items-stretch">
          ...
          <div className="relative h-full">
            ...
            >
              ...
              >
                {t("pricingCards.startMonthly")} <ArrowRight className="h-4 w-4" />
              </Link>
            </MouseFollower>
          </div>
          ...
          <div className="relative h-full">
            ...
            >
              ...
              >
                {t("pricingCards.startYearly")} <ArrowRight className="h-4 w-4" />
              </Link>
            </MouseFollower>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {ALL_FEATURES.map((feature, index) => (
              ...
              >
                ...
                <span className="text-sm font-medium text-slate-700 dark:text-slate-300">{t(feature.textKey)}</span>
              </MouseFollower>
            ))}
          </div>
        </div>

        {/* ========== TRIAL CARD (Light Mode Fixed - Same as Capabilities) ========== */}
        <div className="relative mt-10 overflow-hidden rounded-2xl p-8 text-center shadow-xl sm:flex-row sm:text-left">
          ...
          {/* Dark Mode: Deep Purple Gradient (Same as before) */}
