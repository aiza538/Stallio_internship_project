...
import { Store, Zap, Users, Rocket, Eye, Sparkles } from "lucide-react";
...
const PRINCIPLE_ICONS = [Store, Zap, Users];
      ...
      <div className={`relative mx-auto max-w-content scroll-reveal ${isVisible ? 'visible' : ''}`}>
        <div className="mb-12 text-center">
          ...
          <h2 className="font-display text-3xl font-bold text-slate-800 dark:text-white sm:text-4xl">
            {t("howWeThink.title1")} <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-violet-600 bg-clip-text text-transparent dark:from-indigo-300 dark:via-purple-300 dark:to-violet-300">{t("howWeThink.titleHighlight")}</span>
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-300">{t("howWeThink.subtitle")}</p>
        </div>

        {/* Creative Masonry Style - No Line, Clean Cards */}
            ...
            return (
              ...
              >
                <div className="relative flex flex-col items-center justify-center">
                  ...
                  <h3 className="mt-5 font-display text-lg font-semibold text-slate-800 dark:text-white">{principle.title}</h3>
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 lg:grid-cols-2">
          {fullItems.map((item, index) => {
            const color = index === 0 
              ...
              : { bg: "from-rose-200/80 to-rose-100 dark:from-rose-900/60 dark:to-rose-800/60", iconBg: "bg-rose-200 text-rose-700 dark:bg-rose-800/70 dark:text-rose-400", borderColor: "border-rose-500/70 dark:border-rose-400/60", glowColor: "from-rose-500/40 via-rose-400/20 to-transparent", icon: Eye };
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  <h3 className="mt-4 font-display text-lg font-semibold text-slate-800 dark:text-white">{item.title}</h3>
